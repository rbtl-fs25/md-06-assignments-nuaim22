...
2.  What's the `tidyverse` Package? Describe in maximum two sentences below.
    ...
    *The **tidyverse** is a collection of R packages designed for data science, including tools for data manipulation (**dplyr**), visualization (**ggplot2**), and importing/tidying data (**readr**, **tidyr**). It provides a consistent, intuitive syntax based on the "tidy" data principle, making workflows more efficient and readable.*
...
1.  Starting with the `waste_data_long_mean` object, execute the code and observe the output in the Console. Would you publish this table in this format in a report?
    ...
    *No, I think a wide format would be more appropriate.*
